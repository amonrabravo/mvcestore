...
namespace MVCEStoreWeb.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> List(Parameters parameters)
        {
            ...
            {
                Id = p.Id,
                Picture = p.Picture ?? "/content/images/no-image-800-800.jpg",
                Name = p.Name,
        ...
        private async Task PopulateDropdowns()
        {
            ...
            ViewBag.Categories = new SelectList(await context.Categories.OrderBy(p => p.Name).Select(p => new { p.Id, p.Name, RayonName = p.Rayon.Name }).ToListAsync(), "Id", "Name", null, "RayonName");
        }
    }
}
